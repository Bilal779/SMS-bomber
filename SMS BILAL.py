...
while 1:
   ...
   BİLAL SmsGÖNDERİCİ 
    Sms: {}                         
    Ara: {}              {}VİP {}BİLAL\n  
    """.format(Fore.LIGHTYELLOW_EX, len(servisler_sms), len(servisler_call), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
    ...
    if menu == 1:
        ...
        if tel_no == "":
            ...
            try:
                ...
                sonsuz = "(Sonsuz kadar ise 'enter' tuşuna basınız)"  
            except ValueError:
                system("cls||clear")
